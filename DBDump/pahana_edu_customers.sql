...
CREATE TABLE `customers` (
  ...
  `unit_consumed` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
...
INSERT INTO `customers` VALUES (375,'x','x','s','001',52),(362,'gh','','','',0),(363,'','','','',0),(366,'azx','azx','azx','001',102),(413,'Bill Test Customer','bill@test.com','123 Bill St','9876543210',20);
